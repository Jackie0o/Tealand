    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".hero__slider")) {
                new swiper_core_Swiper(".hero__slider", {
                    modules: [ Navigation, Autoplay, EffectFade, Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
            ...
            if (document.querySelector(".best-menu__slider")) new swiper_core_Swiper(".best-menu__slider", {
            ...
            if (document.querySelector(".peculiarities__slider")) new swiper_core_Swiper(".peculiarities__slider", {
                modules: [ Autoplay, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".unique-items__slider")) new swiper_core_Swiper(".unique-items__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".unique-items__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".unique-items__swiper-button-prev",
                    nextEl: ".unique-items__swiper-button-next"
                },
                breakpoints: {
                    640: {
                        slidesPerView: 2,
...
***************************************************************************** */
        ...
        lightgallery_es5(document.querySelector(".peculiarities__wrapper"), {
            selector: ".peculiarities__image",
            plugins: [ lg_thumbnail_min ],
            licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
            speed: 500,
            mobileSettings: {
        ...
        lightgallery_es5(document.querySelector(".gallery__body"), {
